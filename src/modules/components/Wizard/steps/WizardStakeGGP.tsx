...
export const WizardStakeGGP: FunctionComponent<WizardStakeGGPProps> = ({
  ...
  const defaultGGPAmount: BigNumber = !ggpPrice.data.eq(0)
    ? defaultAVAXAmount.mul(parseEther('0.101')).div(ggpPrice.data)
    : BigNumber.from(0)
  ...
  useEffect(() => {
    if (!ggpPrice.data.eq(0)) {
      setGgpAmount(defaultAVAXAmount.mul(parseEther('0.101')).div(ggpPrice.data))
    }
    ...
    <Flex direction="column">
      ...
      <div className="mb-4 space-y-6">
        ...
        <StakeInput
          ...
          lowerTextValue={futureRatio.mul(100)}
